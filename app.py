...
st.markdown("<p style='text-align: justify; color: black;'>The <i>six</i> physical characteristics of urine, <i>specific gravity</i>, <i>pH value</i>, <i>osmolarity</i>, <i>conductivity</i>, <i>urea</i> and <i>calcium  concentration</i> alongside few secondary characteristics have been provided below. Kindly drag the slider to your left/right for entering the corresponding values based on your report and click on '<b>Predict</b>' button to see if your report indicates presence of any stone in your kidney.</p>", unsafe_allow_html=True)
...
if col3.button("Predict"):
    ...
    st.divider()
    if prediction > 0.3:
        st.markdown("<h5 style='text-align: center; color: black;'>Report suggests presence of stones in your kidney</h5>", unsafe_allow_html=True)
        ...
        st.markdown("<h5 style='text-align: center; color: black;'>Report does not account for presence of stones in your kidney</h5>", unsafe_allow_html=True)
